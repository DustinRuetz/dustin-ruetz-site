...
// Add all CSS files here. Let WordPress add the CSS files to the template automatically instead of linking everything in the header.
...
// Add all JavaScript files here. Let WordPress add the JS files to the template automatically instead of linking everything in the footer.

function hackeryou_scripts() {
	// De-register WordPress' local copy of jQuery
